...
attack_configs = {
    ...
    'deepfool': {'norm': np.inf, 'overshoot': 0.02, 'max_iter': 50, 'target': False},
    ...
    'fgsm': {'norm': 2, 'eps': 8/255, 'target': False, 'loss': 'ce'},
    ...
    'pgd': {'norm': 2, 'eps': 8/255, 'stepsize': 2/255, 'steps': 20, 'target': False, 'loss': 'ce'},
